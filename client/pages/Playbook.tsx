  ...
  return (
    <div className="min-h-screen bg-brand-red">
      ...
      <main className="max-w-6xl mx-auto mt-3 px-4 pb-3">
        ...
        <section id="product" className="bg-black rounded-lg pt-0 px-6 mb-3">
          <h2 className="text-3xl font-black text-white mb-6">PRODUCT & STUDIO PHOTOGRAPHY</h2>
          <div className="text-white space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4">
        ...
        <section id="tips" className="bg-black rounded-lg p-6 mb-6">
          <div className="text-white space-y-6">
            <h2 className="text-4xl font-black text-white mb-6">TIPS, BEST PRACTICES & WARNINGS</h2>
            <h3 className="text-xl font-black text-white mb-3">ITERATE AND EVOLVE</h3>
            <p className="text-white font-bold text-lg mb-4 max-w-3xl text-left my-4">Great images may not come out on the first try. Use the Remix feature to refine. Treat each generation as a prototype – even professional artists make many sketches!</p>
