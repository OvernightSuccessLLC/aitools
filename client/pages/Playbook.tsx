  ...
  return (
    <div className="min-h-screen font-inter" style={{ backgroundColor: '#F0440F' }}>
      ...
      <main className="max-w-[1200px] mx-auto px-4 md:px-6 lg:px-8 py-16 space-y-16">
        ...
        {/* BASICS OF PROMPTING */}
        <section className="bg-black rounded-3xl p-6">
        ...
        <section className="bg-black rounded-3xl p-6">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="font-medium text-[16px] uppercase mb-2" style={{ color: '#F0440F' }}>LOGO DESIGN:</h2>
              <p className="text-white text-[14px]" style={{ lineHeight: '1.6' }}>
            ...
            <div>
              <h2 className="font-medium text-[16px] uppercase mb-2" style={{ color: '#F0440F' }}>WEBSITE BANNER:</h2>
              <p className="text-white text-[14px]" style={{ lineHeight: '1.6' }}>
        ...
        <section className="bg-black rounded-3xl p-6">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="font-medium text-[16px] uppercase mb-2" style={{ color: '#F0440F' }}>ADDING OBJECTS:</h2>
              <p className="text-white text-[14px]" style={{ lineHeight: '1.6' }}>
            ...
            <div>
              <h2 className="font-medium text-[16px] uppercase mb-2" style={{ color: '#F0440F' }}>CHANGING TIME/MOOD:</h2>
              <p className="text-white text-[14px]" style={{ lineHeight: '1.6' }}>
            ...
            <div>
              <h2 className="font-medium text-[16px] uppercase mb-2" style={{ color: '#F0440F' }}>BACKGROUND CHANGES:</h2>
              <p className="text-white text-[14px]" style={{ lineHeight: '1.6' }}>
        ...
        <section className="bg-black rounded-3xl p-6">
          ...
          <h1 className="font-bold text-white text-[28px] uppercase tracking-tight mb-4">ITERATE AND EVOLVE</h1>
