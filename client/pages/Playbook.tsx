...
export default function Playbook() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F0440F' }}>
      <Header />
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-white text-[14px] leading-relaxed" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.6' }}>
        ...
        <section className="bg-black rounded-3xl p-1 mb-16">
          <div className="p-6">
            ...
            <div className="text-center mb-8">
              <p className="text-white text-[18px] leading-relaxed" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.6' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="text-white text-[14px] leading-relaxed space-y-2" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.6' }}>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="text-white text-[14px] leading-relaxed space-y-3" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.6' }}>
